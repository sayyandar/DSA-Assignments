...
void Phonebook::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->loadedFromFile(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Phonebook::*)()>(_a, &Phonebook::contactsChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Phonebook::*)()>(_a, &Phonebook::loadedFromFile, 1))
            return;
    }
}
...
// SIGNAL 0
void Phonebook::contactsChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Phonebook::loadedFromFile()
{
